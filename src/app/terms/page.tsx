      ...
      >
        <div className="flex flex-col gap-6" suppressHydrationWarning>
          <header className="flex flex-col gap-3">
            ...
            <h1 className="text-3xl text-[#111111] sm:text-4xl">Terms</h1>
            <p className="text-sm text-[#111111]/70">
              These terms govern your use of Plated.
            </p>
          </header>
          ...
          >
            <p>
              By using Plated., you agree to use the service responsibly and in
              accordance with applicable laws.
            </p>
            <p>
              Plated. provides recipe parsing and saving tools “as is” without
              warranties of any kind.
            </p>
            <p>
              You are responsible for ensuring that recipe content, ingredient
              measurements, and dietary information meet your needs.
            </p>
            <p>
              Plated. may limit access to features if usage appears abusive,
              automated, or violates these terms.
            </p>
            <p>
              We do not guarantee that every recipe source will be accessible,
              complete, or free of errors.
            </p>
            <p>
              You are responsible for ensuring that recipe content is accurate
              and suitable for your dietary needs.
            </p>
            <p>
