      ...
      >
        <div className="flex flex-col gap-6" suppressHydrationWarning>
          <header className="flex flex-col gap-3">
            ...
            <h1 className="text-3xl text-[#111111] sm:text-4xl">Support</h1>
          ...
          >
            <p>
              For account or recipe issues, please reach out through the app and
              include a brief description of your problem.
            </p>
            <p>
              Include the recipe URL and any error message shown to help us
              diagnose parsing issues quickly.
            </p>
            <p>
              For billing or subscription questions about third-party recipe
              sites, please contact the original publisher directly.
            </p>
            <p>
